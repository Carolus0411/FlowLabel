...
class StockAdjustmentOut extends Model
{
    use Filterable;

    protected $table = 'stock_adjustment_out';
    protected $guarded = [];
    ...
    {
        return $this->hasMany(StockAdjustmentOutDetail::class, 'stock_adjustment_out_id', 'id');
    }
