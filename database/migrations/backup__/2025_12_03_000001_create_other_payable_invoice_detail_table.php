...
return new class extends Migration
{
    ...
    {
        Schema::create('other_payable_invoice_detail', function (Blueprint $table) {
            $table->id();
            $table->foreignId('other_payable_invoice_id')->index();
    ...
    {
        Schema::dropIfExists('other_payable_invoice_detail');
    }
};
