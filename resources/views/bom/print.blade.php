...
<body>
    <div class="container">
        ...
        <div class="info-section">
            <div class="info-left">
                <div class="info-row">
                    <span class="info-label">BOM No :</span>
                    <span class="info-value">{{ $bom->bom_no }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">BOM Date :</span>
                    <span class="info-value">{{ \Carbon\Carbon::parse($bom->bom_date)->format('d F Y') }}</span>
                </div>
            </div>
            ...
            <div class="info-right">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $bom->is_active ? 'Active' : 'Inactive' }}</span>
                </div>
            </div>
        </div>
        ...
        <table>
            <thead>
                <tr>
                    <th class="text-center" style="width: 60px;">No.</th>
                    <th>Material</th>
                    <th class="text-center" style="width: 120px;">Required Qty</th>
                    <th class="text-center" style="width: 80px;">UOM</th>
            ...
            <tbody>
                @forelse($bom->materials as $index => $material)
                <tr>
                    <td class="text-center">{{ $index + 1 }}</td>
                    <td>{{ $material->material->name ?? '-' }}</td>
                    <td class="text-center">{{ number_format($material->required_qty, 2) }}</td>
                    <td class="text-center">{{ $material->uom->name ?? '-' }}</td>
                    <td class="text-center">{{ number_format($material->available_qty, 2) }}</td>
