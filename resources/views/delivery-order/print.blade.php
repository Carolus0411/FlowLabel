    ...
    <div class="container">
        ...
        <div class="info-section">
            <div class="info-left">
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $deliveryOrder->code }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Contact :</span>
                    <span class="info-value">{{ $deliveryOrder->contact->name ?? 'N/A' }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">SO Code :</span>
                    <span class="info-value">{{ $deliveryOrder->sales_order_code ?? '-' }}</span>
                </div>
            </div>
            ...
            <div class="info-right">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ \Carbon\Carbon::parse($deliveryOrder->delivery_date)->format('d F Y') }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Status :</span>
                    <span class="info-value">{{ ucfirst($deliveryOrder->status) }}</span>
                </div>
            </div>
        </div>
        ...
        <table>
            ...
            <tbody>
                ...
                <tr class="total-row">
                    ...
                    <td class="text-right">{{ number_format($deliveryOrder->total_qty, 2) }}</td>
                </tr>
                <tr class="total-row">
                    <td colspan="4" class="text-right">Total Amount (IDR) :</td>
                    <td class="text-right">{{ number_format($deliveryOrder->total_amount, 2, ',', '.') }}</td>
                </tr>
                @endif
            </tbody>
        </table>
        ...
        <div class="signatures">
            <div class="signature-box">
                ...
                <div class="signature-name">{{ $deliveryOrder->contact->name ?? 'Customer' }}</div>
            </div>

            <div class="signature-box">
                <div class="signature-label">Dikirim oleh,</div>
                <div class="signature-name">{{ auth()->user()->name ?? 'Warehouse' }}</div>
            </div>

            <div class="signature-box">
                <div class="signature-label">Disetujui oleh,</div>
                <div class="signature-name">{{ auth()->user()->name ?? 'Manager' }}</div>
            </div>
        </div>
