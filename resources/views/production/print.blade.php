        ...
        <div class="info-section">
            <div class="info-left">
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $production->code }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">BOM :</span>
                    <span class="info-value">{{ $production->bom->bom_no ?? 'N/A' }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Product :</span>
                    <span class="info-value">{{ $production->product->name ?? 'N/A' }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Date :</span>
                    <span class="info-value">{{ \Carbon\Carbon::parse($production->date)->format('d F Y') }}</span>
                </div>
            </div>
            ...
            <div class="info-right">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ number_format($production->qty, 2) }} {{ $production->uom->name ?? '' }}</span>
                </div>
                <div class="info-row">
                    <span class="info-label">Status :</span>
                    <span class="info-value">{{ ucfirst($production->status) }}</span>
                </div>
            </div>
        </div>
