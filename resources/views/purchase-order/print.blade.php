...
<body>
    <div class="container">
        ...
        <div class="info-section">
            <div class="info-left">
                ...
                <div class="info-row">
                    ...
                    <span class="info-value">{{ $purchaseOrder->description ?? '-' }}</span>
                </div>
            </div>
        ...
        <table>
            <thead>
                <tr>
                    ...
                    <th class="text-right" style="width: 180px;">Estimasi (IDR)</th>
                    <th class="text-right" style="width: 200px;">Estimasi Total Harga (IDR)</th>
                </tr>
            </thead>
            <tbody>
                ...
                <tr class="total-row">
                    ...
                    <td class="text-right">{{ number_format($purchaseOrder->order_amount, 2, ',', '.') }}</td>
                </tr>
                @endif
            </tbody>
        </table>
        ...
        <div style="text-align: right; margin-bottom: 10px; font-size: 12px;">
            {{ \Carbon\Carbon::parse($purchaseOrder->order_date)->format('d F Y') }}
        </div>
        ...
        <div class="signatures">
            ...
            <div class="signature-box">
                ...
                <div class="signature-name">Operasional</div>
            </div>

            <div class="signature-box">
                <div class="signature-label">Diajukan oleh,</div>
                <div class="signature-name">{{ auth()->user()->name ?? 'User' }}</div>
            </div>
        </div>
