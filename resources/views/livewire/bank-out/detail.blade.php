...
new class extends Component {
    ...
    {
        return [
            'details' => $this->bankOut->details()->with(['coa','currency'])->get()
        ];
    }
    ...
    public function edit(BankOutDetail $detail): void
    {
        $this->clearForm();
