...
use App\Models\SalesInvoiceDirectDetail;
...
new class extends Component {
    ...
    {
        $this->salesInvoiceDirect = SalesInvoiceDirect::find($id);
    ...
    public function with(): array
    {
        ...
        return [
            'details' => $this->salesInvoiceDirect->details()->with(['serviceCharge','currency','uom'])->get()
        ];
    }
    ...
    public function edit(SalesInvoiceDirectDetail $detail): void
    {
        $this->clearForm();
    ...
    public function save(): void
    {
        ...
        if ($this->mode == 'add')
        {
            $this->salesInvoiceDirect->details()->create([
    ...
    {
        $dpp_amount = $this->salesInvoiceDirect->details()->sum('amount');
    ...
    {
        SalesInvoiceDirectDetail::find($id)->delete();
