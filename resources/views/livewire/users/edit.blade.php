...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        $this->success('User has been updated.', redirectTo: route('users.index'));
    }
}; ?>
        ...
        <x-form wire:submit="save">
            <x-card>
                <div class="space-y-4">
                    ...
                    {{-- <x-choices label="Branch" wire:model="branch_id" :options="$branchSearchable" search-function="searchBranch" option-label="name" single searchable clearable /> --}}
                    <div class="space-y-4 xl:space-y-0 xl:grid grid-cols-2 gap-4">
