...
new class extends Component {
    ...
    public function mount( $id = '', $transport = '', $service_type = '' ): void
    {
        if ($id !== 'new') {
    ...
    {
        $this->open = is_null($this->purchaseOrder->id) || $this->purchaseOrder->status == 'open';

        $details = [];
        if (Schema::hasTable('purchase_order') && !is_null($this->purchaseOrder->id)) {
            $details = $this->purchaseOrder->details()->with(['serviceCharge','currency','uom'])->get();
        }
    ...
    public function edit(PurchaseOrderDetail $detail): void
    {
        $this->clearForm();
    ...
    public function save(): void
    {
        ...
        if (is_null($this->purchaseOrder->id)) {
    ...
    public function calculate(): void
    {
        ...
        $dpp_amount = $this->purchaseOrder->details()->sum('amount');
