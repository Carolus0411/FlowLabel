...
new class extends Component {
    ...
    {
        Gate::authorize('create cash-account');
        $this->searchCurrency();
        $this->searchCoa();
    }
    ...
    public function save(): void
    {
        ...
        $this->success('Cash account successfully created.', redirectTo: route('cash-account.index'));
    }
...
<div>
    <x-header title="Create Cash Account" separator>
        <x-slot:actions>
