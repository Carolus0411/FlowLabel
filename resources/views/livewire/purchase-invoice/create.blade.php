...
new class extends Component {
    ...
    {
        Gate::authorize('create purchase-invoice');
    ...
    public function save($close = false): void
    {
        ...
        $this->success('Invoice successfully created.', redirectTo: route('purchase-invoice.edit', $purchaseInvoice->id));
    }
            ...
            <x-form wire:submit="save">
                <div class="space-y-4">
                    <div class="space-y-4 lg:space-y-0 lg:grid grid-cols-3 gap-4">
                        ...
                        <x-select label="Invoice Type" wire:model="invoice_type" :options="[['id' => 'AP','name' => 'AP']]" placeholder="-- Select --" />
                        <x-choices
                            label="Supplier"
