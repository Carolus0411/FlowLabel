...
new class extends Component {
    ...
    {
        return [
            'details' => $this->cashIn->details()->with(['coa','currency'])->get()
        ];
    }
    ...
    public function edit(CashInDetail $detail): void
    {
        $this->clearForm();
