...
new class extends Component {
    ...
    {
        return [
            'details' => $this->cashOut->details()->with(['coa','currency'])->get()
        ];
    }
    ...
    public function edit(CashOutDetail $detail): void
    {
        $this->clearForm();
