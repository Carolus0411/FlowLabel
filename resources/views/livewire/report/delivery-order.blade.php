...
new #[Layout('components.layouts.app')] class extends Component {
    ...
    public function export()
    {
        ...
        $writer = SimpleExcelWriter::streamDownload('Delivery Order Report.xlsx')
            ->addRows($rows);

        return response()->streamDownload(function () use ($writer) {
            $writer->close();
        }, 'Delivery Order Report.xlsx');
    }
}; ?>

<div>
    <x-header title="Delivery Order Report" separator />
