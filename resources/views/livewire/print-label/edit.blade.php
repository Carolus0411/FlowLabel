...
new class extends Component {
    ...
    public function save(): void
    {
        ...
        $this->success('Print label updated successfully!', redirectTo: route('print-label.index'));
    }
    ...
    public function delete(): void
    {
        ...
        $this->success('Print label deleted successfully!', redirectTo: route('print-label.index'));
    }
};
?>
...
<div>
    <x-header title="Edit Print Label" separator>
        <x-slot:actions>
            <x-button label="Back" link="{{ route('print-label.index') }}" icon="o-arrow-uturn-left" class="btn-soft" responsive />
            @if($orderLabel->file_path)
                <a href="{{ route('print-label.download', ['path' => $orderLabel->file_path]) }}"
        ...
        <div class="lg:col-span-2">
            <x-card title="Order Label Information">
                <x-form wire:submit="save">
                    ...
                    <x-slot:actions>
                        <x-button label="Cancel" link="{{ route('print-label.index') }}" />
