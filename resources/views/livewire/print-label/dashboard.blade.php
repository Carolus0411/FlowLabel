...
<div>
    <x-header title="Print Label Dashboard" separator progress-indicator>
        <x-slot:subtitle>
        ...
        <x-slot:actions>
            <div class="flex gap-2">
                ...
                <x-button label="View All Orders" link="{{ route('print-label.index') }}" icon="o-list-bullet" class="btn-primary btn-sm" />
            </div>
        </x-slot:actions>
    </x-header>
                ...
                <div class="overflow-x-auto">
                    <table class="table table-zebra table-sm">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td>
                                    <a href="{{ route('print-label.edit', $order->id) }}" class="link link-primary font-medium">
                                        {{ $order->code }}
                                    </a>
                                </td>
                                <td>
