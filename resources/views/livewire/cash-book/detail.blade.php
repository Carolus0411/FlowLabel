...
new class extends Component {
    ...
    {
        $this->cashBook = CashBook::find($id);
    ...
    {
        return [
            'details' => $this->cashBook->details()->with(['coa','currency'])->get()
        ];
    }
    ...
    public function edit(CashBookDetail $detail): void
    {
        $this->clearForm();
    ...
    {
        $total_amount = $this->cashBook->details()->sum('amount');
